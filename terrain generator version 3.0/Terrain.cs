    ...
    public partial class Terrain : Form
    {
        ...
        public Terrain(string SettingsFileName, bool generate, string worldDataFile)
        {
            ...
            if (Generate == true)
            {
                ...
                GenerateWorld(Convert.ToInt32(OptionsSaved[1]), Convert.ToInt32(OptionsSaved[0]));
            }
            else
            {
                CreateData();
                LoadWorld(Convert.ToInt32(OptionsSaved[1]), Convert.ToInt32(OptionsSaved[0]));
            }
        }
        ...
        public void GenerateWorld(int WorldHeight, int WorldLength)
        {
            ...
            sw.Close();
            LoadWorld(WorldHeight, WorldLength);
        }
        ...
        public void LoadWorld(int WorldHeight, int WorldLength)
        {
            temp++;
